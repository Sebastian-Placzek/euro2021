...
@section('content')
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="{{route('scoredMatches')}}" class="nav-link active">Scored Matches</a></li>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="/deleteScore?id=<?php echo $match['id'] ?>" class="btn btn-sm btn-outline-primary">Delete score</a>
            </td>
        </tr>
        <?php } ?>
        </tbody>
